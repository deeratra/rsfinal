    ...
    <div style="font-family: 'Gill Sans', 'Gill Sans MT', Calibri, 'Trebuchet MS', sans-serif;margin:30px;">
        <div class="row">
            <div class="col-md-3 bg-dark">
                                <span>
                    <h4 style="color:white; text-align:center">Profile</h4>
                </span>
                <center>
                	<img src="resources/css/user_icon.png" width="100">
                	<br><br>
            ...
            <h3>Edit Staff</h3>
                <form class="m-8" name="registration" onsubmit="return validation()" action="editStaff.html" method="POST">
                <div class="input-group input-group mb-3">
                    <div class="input-group-prepend">
                      <span class="input-group-text" id="inputGroup-sizing-sm">Staff Id</span>
                    </div>
                    <input type="text" name="staffId" readonly value="${id}" class="form-control" aria-label="Small" aria-describedby="inputGroup-sizing-sm">
                  </div>
                  <div class="input-group input-group mb-3">
                    <div class="input-group-prepend">
